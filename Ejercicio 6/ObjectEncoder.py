...
Ingrese Opcion-> """
                ...
                if op == 1: #cargar Heladera
                    ...
                    l = Lavarropa(marca, modelo, color, paisfab, precio, caplav, velcent, cantp, tipop).toJSON()
                    lista.append(l)
                elif op == 0:
                    op = 0
                    print("Fin")
    ...
    def retornarobjeto(self, tipo):
        ...
        if tipo == "Heladera":
            ...
            objeto = Lavarropa(marca, modelo, color, pais, precio, caplav, velcent, cantp, tipop)
        elif tipo == "Televisor":
            tipop = input("Ingrese tipo de pantalla: ")
            pulg = input("Ingrese las pulgadas: ")
            tipod = input("Ingrese el tipo de definicion: ")
